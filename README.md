...
Помимо типа при объявлении переменной можно задать дополнительные параметры, такие как `const`. Он служит для показания токо, что переменная не будет меняться.
...
Это такой производный тип данных, который представляет абстрактную сущность, то есть мы можем придумать свой тип данных
...
Мои дорогие маслята, пришло время практики! Уже слышу ваши радостные вопли.

<img align="center" width="350" height="400" src="https://sun9-38.userapi.com/impf/Rk9DXpClzk29mznQ7sd6oTRmFqs8fhhOb4rP5A/VTocxf7Az_I.jpg?size=311x320&quality=96&sign=b2435cfb157c5303fc494f3750f0737c&type=album">

Задания не очень сложные, если вы конечно внимательно читали)
При любой трудности пишите (в гугл), он с радостью вам поможет (только не списывайте, себя же обманываете).

Всех выполнивших ждёт поцелуйчик, ну а пока за дело, солнце ещё высоко (ну наверно, не знаю когда ты там это читаешь)!

## Задание

0. С памятью у всех всё хорошо, помним про наше **[задание с нулевой лабы](https://github.com/c-cpp-labs/lab-00-git/blob/master/README.md#%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5)**
